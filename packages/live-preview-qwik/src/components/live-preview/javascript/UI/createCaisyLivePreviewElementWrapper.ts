...
type ICreateCaisyLivePreviewElementWrapper = ({ children }: { children?: HTMLElement | HTMLElement[] }) => HTMLElement;

const createCaisyLivePreviewElementWrapper: ICreateCaisyLivePreviewElementWrapper = ({ children }) => {
