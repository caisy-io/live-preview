...
import { makeDraggableElement } from "./makeDraggableElement";

type IConnectionState = "Connected" | "Reconnecting" | "Disconnected";

const WIDTH_BY_STATE: any = {
    Connected: 230,
    Reconnecting: 293,
    Disconnected: 293,
};

const HEIGHT_BY_STATE: any = {
    Connected: 48,
    Reconnecting: 130,
    Disconnected: 112,
};
...
const createCaisyConnectionIndicator = ({
    ...
    makeDraggableElement(indicator, dragHandler);
    ...
    const observer = new MutationObserver(() => {
        ...
        const contentElement = document.querySelector(".caisy-connection-indicator-content");
        ...
        if (description) {
            ...
            const descriptionElement = document.querySelector(".caisy-connection-indicator-description");
