...
const loaded = (0, styled_components_1.css) `
  opacity: 1;
`;
const _cover = (0, styled_components_1.css) `
  object-fit: cover;
`;
...
const Bronze = (0, styled_components_1.css) `
  ...
  img {
    height: 100%;
    ${({ cover, contain }) => (!contain && cover ? _cover : "")};
    ${({ contain }) => (contain ? _contain : "")};
    width: 100%;
  }
`;
...
exports.SImg = styled_components_1.default.div `
  ${Bronze};
