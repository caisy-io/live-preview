...
const Bronze = (0, styled_components_1.css) `
  padding: 0 ${grid_1.PADDING.BRONZE};
`;
const Silver = (0, styled_components_1.css) `
  padding: 0 ${grid_1.PADDING.SILVER};
`;
const Gold = (0, styled_components_1.css) `
  padding: 0 ${grid_1.PADDING.GOLD};
`;
const Platinum = (0, styled_components_1.css) `
  padding: 0 ${grid_1.PADDING.PLATINUM};
`;
const Diamond = (0, styled_components_1.css) `
  padding: 0 ${grid_1.PADDING.DIAMOND};
  max-width: 1920px;
  margin: 0 auto;
`;
exports.SGridPadding = styled_components_1.default.div `
  ${Bronze};
