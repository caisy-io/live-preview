...
exports.SFooterCopyright = void 0;
const styled_components_1 = __importStar(require("styled-components"));
const mediaquerys_1 = require("../../../constants/styles/mediaquerys");
const SFooterLeftSection_1 = require("./SFooterLeftSection");
const SFooterRightSection_1 = require("./SFooterRightSection");
const Bronze = (0, styled_components_1.css) `
  ...
  text-align: center;
  ${SFooterLeftSection_1.SFooterLeftSection} & {
    display: none;
  }
  ${SFooterRightSection_1.SFooterRightSection} & {
    display: block;
  }
`;
...
exports.SFooterCopyright = styled_components_1.default.p `
  ${Bronze}
