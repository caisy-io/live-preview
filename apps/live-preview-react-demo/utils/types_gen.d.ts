...
export declare enum IGenCompButtonExternalLinks_Style {
    Inverted = "Inverted",
...
export declare enum IGenCompButton_Style {
    Inverted = "Inverted",
    WithBackground = "WithBackground",
    WithoutBackground = "WithoutBackground"
}
...
export type IGenCompFaqItem_Description_Connections = IGenCaisy_Field_Document_NotFound;
...
export type IGenCompFooterSection_Links = IGenCompButton | IGenCompButtonExternalLinks;
...
export declare enum IGenCompGridBrandCard_Style {
    JustLogo = "justLogo",
...
export declare enum IGenCompGrid_NumberOfColumns {
...
export type IGenCompGrid_Items = IGenCompGridBrandCard | IGenCompGridTeamMemberCard;
...
export type IGenCompHeroSliderSlide = {
    ...
    _meta?: Maybe<IGenCaisyDocument_Meta>;
    backgroundImage?: Maybe<Array<Maybe<IGenCompHeroSliderSlide_BackgroundImage>>>;
    headline?: Maybe<Scalars["String"]>;
    id?: Maybe<Scalars["ID"]>;
...
export type IGenCompHeroSliderSlide_Text_Connections = IGenCaisy_Field_Document_NotFound;
...
export type IGenCompImageWithText_Buttons = IGenCompButton | IGenCompButtonExternalLinks;
...
export type IGenCompImageWithText_Text_Connections = IGenCaisy_Field_Document_NotFound;
...
export type IGenCompTextBlock_Buttons = IGenCompButton | IGenCompButtonExternalLinks;
...
export type IGenCompTextBlock_Text_Connections = IGenCaisy_Field_Document_NotFound;
...
export type IGenFooter_LegalSection = IGenCompButton | IGenCompButtonExternalLinks;
...
export declare enum IGenPage_SitemapPriority {
...
export type IGenPage_Components = IGenCompFacts | IGenCompFaq | IGenCompGrid | IGenCompHeroSlider | IGenCompImageWithText | IGenCompPageHeader | IGenCompSectionHeader | IGenCompTextBlock;
...
export type IGenUniversalText = {
    ...
    pageNotFoundButton?: Maybe<Array<Maybe<IGenUniversalText_PageNotFoundButton>>>;
...
export type IGenUniversalText_PageNotFoundButton = IGenCompButton | IGenCompButtonExternalLinks;
export type IGenUniversalText_PageNotFoundDescription = {
    __typename: "UniversalText_pageNotFoundDescription";
    connections?: Maybe<Array<Maybe<IGenUniversalText_PageNotFoundDescription_Connections>>>;
    json?: Maybe<Scalars["JSON"]>;
};
export type IGenUniversalText_PageNotFoundDescription_Connections = IGenCaisy_Field_Document_NotFound;
